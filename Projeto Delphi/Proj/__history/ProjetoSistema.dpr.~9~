...
uses
  ...
  UnFormInicializaSistema in '..\Src\Tela Inicialização Sistema\UnFormInicializaSistema.pas' {Form2},
  ...
  UnFormPadraoCadastro in '..\Src\Formularios Padrão Framework\UnFormPadraoCadastro.pas',
